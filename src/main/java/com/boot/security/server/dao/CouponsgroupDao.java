...
public interface CouponsgroupDao {
    ...
    @Insert("insert into couponsgroup(GroupCode, CouponsType, CouponsName, EffectiveDate, ExpireDate,ReductionType, ThresholdAmount, ReductionPrice,IsShare, Remark, CanUseCinemaType, CinemaCodes, Status, CouponsNumber, IssuedNumber, FetchNumber, RemainingNumber, UsedNumber, CreateDate, UpdateDate,IsShareWithMemberCard) values(#{GroupCode}, #{CouponsType}, #{CouponsName},#{EffectiveDate}, #{ExpireDate}, #{ReductionType}, #{ThresholdAmount}, #{ReductionPrice},#{IsShare}, #{Remark}, #{CanUseCinemaType}, #{CinemaCodes}, #{Status}, #{CouponsNumber}, #{IssuedNumber}, #{FetchNumber}, #{RemainingNumber}, #{UsedNumber},#{CreateDate}, #{UpdateDate},#{IsShareWithMemberCard})")
