...
public interface CinemaDao {
    ...
    @Insert("insert into cinema(MId, Code, Name, Province, City, Address, ScreenCount, ManualAdd, IsOpen, ContactName, ContactMobile, TheaterChain, Latitude, Longitude, IsOpenSnacks, CinemaPhone, TicketHint, CinemaLabel, IsSnackDistribution, Created, Updated, CinemaId, IsUseLowestPriceReport, OverRefundTime, RefundFee, SmsAccount, SmsPwd, SmsSignId, BusinessPic, BusinessName, BusinessDesc) values(#{MId}, #{Code}, #{Name}, #{Province}, #{City}, #{Address}, #{ScreenCount}, #{ManualAdd}, #{IsOpen}, #{ContactName}, #{ContactMobile}, #{TheaterChain}, #{Latitude}, #{Longitude}, #{IsOpenSnacks}, #{CinemaPhone}, #{TicketHint}, #{CinemaLabel}, #{IsSnackDistribution}, #{Created}, #{Updated}, #{CinemaId}, #{IsUseLowestPriceReport}, #{OverRefundTime}, #{RefundFee}, #{SmsAccount}, #{SmsPwd}, #{SmsSignId}, #{BusinessPic}, #{BusinessName}, #{BusinessDesc})")
