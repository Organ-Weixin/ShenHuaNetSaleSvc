...
public interface CinemaDao {
    ...
    @Insert("insert into cinema(MId, Code, Name, Province, City, Address, ScreenCount, ManualAdd, IsOpen, ContactName, ContactMobile, TheaterChain, Latitude, Longitude, IsOpenSnacks, CinemaPhone, TicketHint, CinemaLabel, IsSnackDistribution, Created, Updated, CinemaId, QmmCinemaId, IsUseLowestPriceReport, IsGeneralStore, OverRefundTime, RefundFee, SmsAccount, SmsPwd, SmsSignId, BusinessPic, BusinessName, BusinessDesc) values(#{MId}, #{Code}, #{Name}, #{Province}, #{City}, #{Address}, #{ScreenCount}, #{ManualAdd}, #{IsOpen}, #{ContactName}, #{ContactMobile}, #{TheaterChain}, #{Latitude}, #{Longitude}, #{IsOpenSnacks}, #{CinemaPhone}, #{TicketHint}, #{CinemaLabel}, #{IsSnackDistribution}, #{Created}, #{Updated}, #{CinemaId}, #{QmmCinemaId}, #{IsUseLowestPriceReport}, 0, #{OverRefundTime}, #{RefundFee}, #{SmsAccount}, #{SmsPwd}, #{SmsSignId}, #{BusinessPic}, #{BusinessName}, #{BusinessDesc})")
