...
public interface OrdersDao {
	...
	@Insert("insert into orders(CinemaCode, UserId, SessionCode, ScreenCode, SessionTime, FilmCode, FilmName, TicketCount, TotalPrice, TotalFee, TotalSalePrice, OrderStatus, MobilePhone, LockTime, AutoUnlockDatetime, LockOrderCode, SubmitTime, SubmitOrderCode, PrintNo, VerifyCode, PrintStatus, PrintTime, RefundTime, Created, Updated, Deleted, ErrorMessage, SerialNum, IsMemberPay, PayType, Printpassword, PaySeqNo, TotalLoveSeatDifferences, FeePayType, TotalGuestPayFee, RefundTradeNo, PayFlag, OrderPayType, PayTime, OrderTradeNo, CardNo, CardPassword, IDCardNumber, MarketingCode, OpenID, CouponsCode, CouponsPrice,TotalAddFee,TotalCinemaAllowance,TotalRefundPrice,EwmPic,minimumFare)"
			+ "values(#{CinemaCode}, #{UserId}, #{SessionCode}, #{ScreenCode}, #{SessionTime}, #{FilmCode}, #{FilmName}, #{TicketCount}, #{TotalPrice}, #{TotalFee}, #{TotalSalePrice}, #{OrderStatus}, #{MobilePhone}, #{LockTime}, #{AutoUnlockDatetime}, #{LockOrderCode}, #{SubmitTime}, #{SubmitOrderCode}, #{PrintNo}, #{VerifyCode}, #{PrintStatus}, #{PrintTime}, #{RefundTime}, #{Created}, #{Updated}, #{Deleted}, #{ErrorMessage}, #{SerialNum}, #{IsMemberPay}, #{PayType}, #{Printpassword}, #{PaySeqNo}, #{TotalLoveSeatDifferences}, #{FeePayType}, #{TotalGuestPayFee}, #{RefundTradeNo}, #{PayFlag}, #{OrderPayType}, #{PayTime}, #{OrderTradeNo}, #{CardNo}, #{CardPassword}, #{IDCardNumber}, #{MarketingCode}, #{OpenID}, #{CouponsCode}, #{CouponsPrice},#{TotalAddFee},#{TotalCinemaAllowance},#{TotalRefundPrice},#{EwmPic},#{minimumFare})")
