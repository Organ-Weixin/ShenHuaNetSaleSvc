...
public interface MembercardcreditruleDao {
    ...
    @Insert("insert into membercardcreditrule(Id, CinemaCode, RuleCode, RuleName, RuleType, LevelCode, LevelName, CreateTime, Credit, EffectiveDays, RuleDescription, UpdateTime, Status) values(#{Id}, #{CinemaCode}, #{RuleCode}, #{RuleName}, #{CreateTime}, #{RuleType}, #{LevelCode}, #{LevelName}, #{Credit}, #{EffectiveDays}, #{RuleDescription}, #{UpdateTime}, #{Status})")
