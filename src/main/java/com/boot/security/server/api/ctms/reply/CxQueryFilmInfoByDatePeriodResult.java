 ...
 * 影片信息
 */
public class CxQueryFilmInfoByDatePeriodResult {
	private ResBean QueryFilmInfoByDatePeriodResult;

	public ResBean getQueryFilmInfoByDatePeriodResult() {
		return QueryFilmInfoByDatePeriodResult;
	}

	public void setQueryFilmInfoByDatePeriodResult(ResBean queryFilmInfoByDatePeriodResult) {
		QueryFilmInfoByDatePeriodResult = queryFilmInfoByDatePeriodResult;
	}
