...
import com.boot.security.server.apicontroller.reply.QueryUserConponsPagedReply;
import com.boot.security.server.apicontroller.reply.QueryUserConponsPagedReply.QueryUserConponsPagedBeans.QueryUserConponsPagedBean;
...
public class ConponController {
	...
	public QueryUserConponsReply QueryUserConpons(@PathVariable String UserName,@PathVariable String Password,@PathVariable String CinemaCode,@PathVariable String OpenID,@PathVariable String Status){
		...
		List<Couponsgroup> couponsgroup=_couponsgroupService.getByCinemaCodes(CinemaCode);
